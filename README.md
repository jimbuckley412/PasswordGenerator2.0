...
The generator will utilize STRINGS of lowercase & uppercase letters, numbers and special characters.  From all these special characters, numbers and letters both upper and lower case to randomly generate a safe and secure password. The Math.random() and Math.floor() method will be used to achieve this. I will generate a password lenght of 12 to 128.  Helps solve the problem of creating a secure password. I learned how to incorporate javaScript to make a functioning app that generates a password. 
...
You can look at my Github Page @ https://github.com/jimbuckley412/PasswordGenerator2.0
You can use my Password-Generator @ https://jimbuckley412.github.io/PasswordGenerator2.0/
...
Password generator that generates a password from 12 to 128 characters long.  It will be a secure password generator that uses more than 1 type of character type.  It will use javaScript to run the password generator.  The generator will be able to be used by anyone.  It will be used to create a secure password. That will randomly generate a combination of lowercase and uppercase letters, numbers and special characters.  
## How to Contribute
